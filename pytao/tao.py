...
class Tao(_TaoAutogeneratedCommandMixin, TaoCore):
    ...
    def get_initial_particles(
        ...
        *,
        ...
        ele_id = ElementID(universe=int(ix_uni or 1), ele_id=track_start)

        try:
            return self.particles(
                ele_id.tao_string, which=which, ix_bunch=ix_bunch, verbose=verbose
            )
        except TaoCommandError as ex:
    ...
    def init_particles(
        ...
        *,
        ...
        try:
            ...
            init_particles = self.particles(track_start)
        finally:
