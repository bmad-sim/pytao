...
from . import pbar
from .core import AnyPath, TaoCore, configure_logging_from_env, is_in_subprocess
...
class Tao(_TaoAutogeneratedCommandMixin, TaoCore):
    ...
    def eles(
        ...
        * type::bpm*  (elements with a type that starts with "bpm")
        ...
        track_only : bool, optional
            If set, lord elements will not be included.
            Defaults to False.
        defaults : bool, default=True
            Fill default items.  Defaults are set by name in `Element.DEFAULTS`.
        attrs : bool, optional
        ...
        if not ele_id:
            ids = self.ele_ids_from_superuniverse(track_only=track_only, no_slaves=no_slaves)
        else:
            flags = ["-array_out"]
            if track_only:
    ...
    def unique_ele_ids_from_branch(
        ...
        """
        return self.ele_ids_from_branch(ix_uni, ix_branch, no_slaves=True)
    ...
    def unique_ele_ids_from_universe(self, ix_uni: str | int) -> list[str]:
        ...
        """
        return self.ele_ids_from_universe(ix_uni, no_slaves=True)
    ...
    def unique_ele_ids_from_superuniverse(self) -> list[str]:
        ...
        """
        return self.ele_ids_from_superuniverse(no_slaves=True)
    ...
    def unique_ele_ids(self, *selectors: str):
        ...
        *selectors : str
        ...
        """
        return self.ele_ids(*selectors, no_slaves=True)
    ...
    def ele_ids_from_branch(
        ...
        *,
        ...
        """
        Retrieve element IDs from a specific universe and branch.

        Defaults to retrieving all element IDs, with `track_only=False`
        and `no_slaves=False`.
    ...
    def ele_ids_from_universe(
        self, ix_uni: str | int, track_only: bool = False, no_slaves: bool = False
    ) -> list[str]:
        """
        Retrieve element IDs from all branches in a universe.
    ...
    def ele_ids_from_superuniverse(
        self, track_only: bool = False, no_slaves: bool = False
    ) -> list[str]:
        """
        Retrieve element IDs from all universes in the Tao superuniverse.
        ...
        for ix_uni in self.inum("ix_universe"):
            ele_ids.extend(
                self.ele_ids_from_universe(
                    ix_uni=ix_uni, track_only=track_only, no_slaves=no_slaves
                )
            )
        return ele_ids

    def ele_ids(self, *selectors: str, track_only=False, no_slaves=False):
        """
        Retrieve unique element IDs based on universe/branch-selectors and/or specific IDs.
        ...
        *selectors : str
        ...
        """
        if not selectors:
            return self.ele_ids_from_superuniverse(track_only=track_only, no_slaves=no_slaves)
