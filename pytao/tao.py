...
class Tao(_TaoAutogeneratedCommandMixin, TaoCore):
    ...
    def init(
        ...
        *,
        ...
        cmd : str, optional
            ...
            replaced by your home directory.
        plot : str, bool, optional
            Use pytao's plotting mechanism with matplotlib, bokeh, or plotly,
            if available.
            If `True`, pytao will pick an appropriate plotting backend.
            If `False` or "tao", Tao plotting will be used. (Default)
            If "mpl", the pytao matplotlib plotting backend will be selected.
    ...
    def plot_manager(
        ...
        BokehGraphManager | NotebookGraphManager | MatplotlibGraphManager | PlotlyGraphManager
    ):
        """
    ...
    def plot(
        ...
        **kwargs,
        ...
        backend : {"bokeh", "mpl", "plotly"}, optional
