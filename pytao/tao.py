...
from . import pbar
from .core import AnyPath, TaoCore, TaoInitializationError
...
class Tao(_TaoAutogeneratedCommandMixin, TaoCore):
        ...
        *,
        ...
        try:
            ...
            raise TaoInitializationError(
                f"Invalid 'cmd'/'init' arguments passed: {cmd!r}. "
                f"See `tao` or `pytao --help` for appropriate options. "
            ) from ex
    ...
    def get_config(self) -> TaoConfig:
        """
        Get a configuration object representing the state of Tao.
        """
        return TaoConfig.from_tao(self)
