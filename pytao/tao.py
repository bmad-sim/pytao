...
class Tao(_TaoAutogeneratedCommandMixin, TaoCore):
    ...
    def init(
        ...
        *,
        ...
        if not self._tao_version_checked and _should_check_version():
    ...
    def get_initial_particles(
        ...
        *,
        ...
        verbose : bool, optional
            Passed to command functions (e.g., bunch_params).  Defaults to None.
    ...
    def _get_temp_file_name(self, name: str):
        """
        Get a temporary filename in the instance-specific temporary directory.
        ...
        return pathlib.Path(self._temp_dir.name) / name
    ...
    def set_initial_particles(
        ...
        *,
        ...
        if isinstance(particles, (pathlib.Path, str)):
            ...
            write_to = write_to or self._get_temp_file_name(
        ...
        try:
            conf.beam_init.set(self, only_changed=True)
