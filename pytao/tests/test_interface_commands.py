...
# Generated on: 2024-06-25 10:43:22
# ==============================================================================
...
def test_building_wall_section_1():
    tao = new_tao("-init $ACC_ROOT_DIR/regression_tests/python_test/cesr/tao.init")
    tao.building_wall_section(ix_section="1", sec_name="test", sec_constraint="none")
...
def test_plot_template_manage_1():
    ...
    tao.plot_template_manage(
        template_location="@T1", template_name="beta", n_graph="2", graph_names="g1^^g2"
    )
...
def test_plot_curve_manage_1():
    ...
    tao.plot_curve_manage(graph_name="beta.g", curve_index="1", curve_name="r13.g.a")
