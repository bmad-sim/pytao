...
def test_beam_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/csr_beam_tracking/tao.init -external_plotting -noplot'))
...
def test_bmad_com_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/cesr/tao.init -external_plotting -noplot'))
...
def test_building_wall_list_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_wall -external_plotting -noplot'))
...
def test_constraints_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_optics_matching -external_plotting -noplot'))
...
def test_ele_cartesian_map_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_em_field -external_plotting -noplot'))
    ret = interface_commands.ele_cartesian_map(tao, ele_id='1@0>>1', which='model', index='1', who='base')
            
        
def test_ele_chamber_wall_1():
    
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_wall3d -external_plotting -noplot'))
...
def test_ele_taylor_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_taylor -external_plotting -noplot'))
    ret = interface_commands.ele_taylor(tao, ele_id='1@0>>34', which='model')
            
        
def test_ele_spin_taylor_1():
    
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_spin -external_plotting -noplot'))
    ret = interface_commands.ele_spin_taylor(tao, ele_id='1@0>>2', which='model')
            
        
def test_ele_wake_1():
    
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_wake -external_plotting -noplot'))
...
def test_ele_grid_field_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_grid -external_plotting -noplot'))
...
def test_ele_photon_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_photon -external_plotting -noplot'))
...
def test_floor_orbit_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_floor_orbit -external_plotting -noplot'))
...
def test_plot_line_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_plot_line -external_plotting -external_plotting -noplot'))
...
def test_plot_symbol_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_plot_line -external_plotting -external_plotting -noplot'))
    ret = interface_commands.plot_symbol(tao, region_name='r11', graph_name='g', curve_name='a', x_or_y='')
...
def test_shape_pattern_list_1():
    ...
    tao = Tao(os.path.expandvars('-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_shape -external_plotting -noplot'))
