...
# Generated on: 2025-09-24 18:10:53
# ==============================================================================
...
def test_beam_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/csr_beam_tracking/tao.init', external_plotting=False) as tao:
...
def test_bmad_com_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/cesr/tao.init', external_plotting=False) as tao:
...
def test_building_wall_list_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_wall', external_plotting=False) as tao:
...
def test_building_wall_point_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_wall', external_plotting=False) as tao:
            tao.building_wall_point(ix_section='1', ix_point='1', z='0', x='0', radius='0', z_center='0', x_center='0', verbose=True)
...
def test_building_wall_section_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/cesr/tao.init', external_plotting=False) as tao:
            tao.building_wall_section(ix_section='1', sec_name='test', sec_constraint='none', verbose=True)
                
            
def test_constraints_1(caplog, tao_cls):
    
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_optics_matching', external_plotting=False) as tao:
...
def test_data_d2_create_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_optics_matching', external_plotting=False) as tao:
            tao.data_d2_create(ix_uni='1', d2_name='orbit', n_d1_data='2', d_data_arrays_name_min_max='x^^0^^45^^y^^1^^47', verbose=True)
...
def test_datum_create_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_optics_matching', external_plotting=False) as tao:
            tao.datum_create(datum_name='twiss.end[6]', data_type='beta.y', ele_ref_name='', ele_start_name='', ele_name='P1', merit_type='target', meas='0', good_meas='T', ref='0', good_ref='T', weight='0.3', good_user='T', data_source='lat', eval_point='END', s_offset='0', ix_bunch='1', invalid_value='0', verbose=True)
...
def test_ele_cartesian_map_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_em_field', external_plotting=False) as tao:
            tao.ele_cartesian_map(ele_id='1@0>>1', which='model', index='1', who='base', verbose=True)
                
            
def test_ele_chamber_wall_1(caplog, tao_cls):
    
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_wall3d', external_plotting=False) as tao:
            tao.ele_chamber_wall(ele_id='1@0>>1', which='model', index='1', who='x', verbose=True)
...
def test_ele_cylindrical_map_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_em_field', external_plotting=False) as tao:
            tao.ele_cylindrical_map(ele_id='1@0>>5', which='model', index='1', who='base', verbose=True)
...
def test_ele_gen_grad_map_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_em_field', external_plotting=False) as tao:
            tao.ele_gen_grad_map(ele_id='1@0>>9', which='model', index='1', who='derivs', verbose=True)
                
            
def test_ele_grid_field_1(caplog, tao_cls):
    
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_grid', external_plotting=False) as tao:
            tao.ele_grid_field(ele_id='1@0>>1', which='model', index='1', who='base', verbose=True)
...
def test_ele_lord_slave_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/cesr/tao.init', external_plotting=False) as tao:
            tao.ele_lord_slave(ele_id='1@0>>1', verbose=True)
...
def test_ele_param_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_photon', external_plotting=False) as tao:
...
def test_ele_spin_taylor_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_spin', external_plotting=False) as tao:
...
def test_ele_taylor_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_taylor', external_plotting=False) as tao:
...
def test_ele_wake_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_wake', external_plotting=False) as tao:
...
def test_ele_wall3d_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_wall3d', external_plotting=False) as tao:
            tao.ele_wall3d(ele_id='1@0>>1', which='model', index='1', who='table', verbose=True)
...
def test_em_field_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/cesr/tao.init', external_plotting=False) as tao:
            tao.em_field(ele_id='1@0>>22', which='model', x='0', y='0', z='0', t_or_z='0', verbose=True)
...
def test_floor_orbit_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_floor_orbit', external_plotting=False) as tao:
...
def test_lat_header_1(caplog, tao_cls):
    
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/cesr/tao.init', external_plotting=False) as tao:
            tao.lat_header(ix_uni='1', verbose=True)
...
def test_lat_list_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/cesr/tao.init', external_plotting=False) as tao:
            tao.lat_list(ix_uni='1', ix_branch='0', elements='Q*', which='model', who='orbit.floor.x', verbose=True)
...
def test_lat_list_2(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/cesr/tao.init', external_plotting=False) as tao:
            tao.lat_list(ix_uni='1', ix_branch='0', elements='Q*', which='design', who='ele.ix_ele', verbose=True)
...
def test_lord_control_1(caplog, tao_cls):
    
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/cesr/tao.init', external_plotting=False) as tao:
            tao.lord_control(ele_id='sex_20w', verbose=True)
...
def test_plot_template_manage_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_optics_matching', external_plotting=False) as tao:
            tao.plot_template_manage(template_location='@T1', template_name='beta', n_graph='2', graph_names='g1^^g2', verbose=True)
...
def test_plot_curve_manage_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_optics_matching', external_plotting=False) as tao:
            tao.plot_curve_manage(graph_name='beta.g', curve_index='1', curve_name='r13.g.a', verbose=True)
...
def test_plot_graph_manage_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_optics_matching', external_plotting=False) as tao:
            tao.plot_graph_manage(plot_name='beta', graph_index='1', graph_name='beta.g', verbose=True)
                
            
def test_plot_line_1(caplog, tao_cls):
    
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_plot_line -external_plotting', external_plotting=False) as tao:
            tao.plot_line(region_name='beta', graph_name='g', curve_name='a', x_or_y='', verbose=True)
...
def test_plot_line_2(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_plot_line -external_plotting', external_plotting=False) as tao:
            tao.plot_line(region_name='beta', graph_name='g', curve_name='a', x_or_y='y', verbose=True)
...
def test_plot_symbol_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_plot_line -external_plotting', external_plotting=False) as tao:
            tao.plot_symbol(region_name='r13', graph_name='g', curve_name='a', x_or_y='', verbose=True)
...
def test_plot_symbol_2(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_plot_line -external_plotting', external_plotting=False) as tao:
            tao.plot_symbol(region_name='r13', graph_name='g', curve_name='a', x_or_y='y', verbose=True)
...
def test_shape_pattern_list_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_shape', external_plotting=False) as tao:
...
def test_shape_pattern_manage_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_shape', external_plotting=False) as tao:
            tao.shape_pattern_manage(ix_pattern='1', pat_name='new_pat', pat_line_width='1', verbose=True)
...
def test_shape_pattern_point_manage_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_shape', external_plotting=False) as tao:
            tao.shape_pattern_point_manage(ix_pattern='1', ix_point='1', s='0', x='0', verbose=True)
...
def test_shape_set_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/cesr/tao.init', external_plotting=False) as tao:
            tao.shape_set(who='floor_plan', shape_index='1', ele_name='Q1', shape='circle', color='', shape_size='', type_label='', shape_draw='', multi_shape='', line_width='', verbose=True)
...
def test_slave_control_1(caplog, tao_cls):
    
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/cesr/tao.init', external_plotting=False) as tao:
            tao.slave_control(ele_id='ASYM_IR', verbose=True)
...
def test_spin_invariant_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/cesr/tao.init', external_plotting=False) as tao:
            tao.spin_invariant(who='l0', ix_uni='1', ix_branch='0', which='model', verbose=True)
...
def test_var_create_1(caplog, tao_cls):
    ...
    with ensure_successful_parsing(caplog):
        with new_tao(tao_cls, '-init $ACC_ROOT_DIR/regression_tests/pipe_test/tao.init_optics_matching', external_plotting=False) as tao:
            tao.var_create(var_name='quad[1]', ele_name='Q1', attribute='L', universes='1', weight='0.001', step='0.001', low_lim='-10', high_lim='10', merit_type='', good_user='T', key_bound='T', key_delta='0.01', verbose=True)
