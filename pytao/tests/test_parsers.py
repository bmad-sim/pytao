...
def test_building_wall_list_1(tao_cls):
    with new_tao(tao_cls, "-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_wall") as tao:
...
def test_constraints_1(tao_cls):
    with new_tao(tao_cls, "-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_optics_matching") as tao:
        tao.constraints(who="data")


def test_constraints_2(tao_cls):
    with new_tao(tao_cls, "-init $ACC_ROOT_DIR/regression_tests/python_test/cesr/tao.init") as tao:
...
def test_ele_chamber_wall_1(tao_cls):
    with new_tao(tao_cls, "-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_wall3d") as tao:
        assert set(
...
def test_ele_gen_grad_map_1(tao_cls):
    with new_tao(tao_cls, "-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_em_field") as tao:
        assert set(
...
def test_ele_taylor_1(tao_cls):
    with new_tao(tao_cls, "-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_taylor") as tao:
...
def test_ele_spin_taylor_1(tao_cls):
    with new_tao(tao_cls, "-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_spin") as tao:
...
def test_floor_orbit_1(tao_cls):
    with new_tao(tao_cls,  "-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_floor_orbit") as tao:
...
def test_plot_line_1(tao_cls):
    with new_tao(tao_cls,  "-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_plot_line -external_plotting") as tao:
...
def test_shape_pattern_list_1(tao_cls):
    with new_tao(tao_cls, "-init $ACC_ROOT_DIR/regression_tests/python_test/tao.init_shape") as tao:
...
def test_lat_list_from_chris(tao_cls):
    with new_tao(tao_cls, "-init $ACC_ROOT_DIR/bmad-doc/tao_examples/cesr/tao.init -noplot") as tao:
