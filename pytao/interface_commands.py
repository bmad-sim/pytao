...
# Generated on: 2026-08-25 14:54:17
# ==============================================================================
...
class _TaoAutogeneratedCommandMixin(TaoCore):
    ...
    def beam(self, ix_branch, *, ix_uni="", verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def beam_init(self, ix_branch, *, ix_uni="", verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def bmad_com(self, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def branch1(self, ix_uni, ix_branch, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def bunch_params(
        self, ele_id, *, which="model", verbose=False, raises=True
    ) -> dict[str, Any]:
        """
    ...
    def building_wall_list(
        self, *, ix_section="", verbose=False, raises=True
    ...
    def building_wall_graph(
        self, graph, *, verbose=False, raises=True
    ...
    def constraints(
        self, who, *, verbose=False, raises=True
    ) -> list[ConstraintDataInfo] | list[ConstraintVarInfo]:
        """
    ...
    def da_aperture(self, *, ix_uni="", verbose=False, raises=True) -> list[DaApertureInfo]:
        """
    ...
    def da_params(self, *, ix_uni="", verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def data(
        self, d2_name, d1_name, *, ix_uni="", dat_index="1", verbose=False, raises=True
    ) -> dict[str, Any]:
        """
    ...
    def data_d_array(
        self, d2_name, d1_name, *, ix_uni="", verbose=False, raises=True
    ) -> list[DataDArrayInfo]:
        """
    ...
    def data_d1_array(
        self, d2_datum, *, ix_uni="", verbose=False, raises=True
    ) -> list[DataD1ArrayInfo]:
        """
    ...
    def data_d2(self, d2_name, *, ix_uni="", verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def data_d2_array(self, ix_uni, *, verbose=False, raises=True) -> list[str]:
        """
    ...
    def data_d2_destroy(self, d2_name, *, ix_uni="", verbose=False, raises=True) -> None:
        """
    ...
    def data_parameter(
        self, data_array, parameter, *, verbose=False, raises=True
    ) -> list[DataParameterLineInfo]:
        """
    ...
    def data_set_design_value(self, *, verbose=False, raises=True) -> None:
        """
    ...
    def datum_has_ele(self, datum_type, *, verbose=False, raises=True) -> str | None:
        """
    ...
    def derivative(self, *, verbose=False, raises=True) -> dict[int, np.ndarray]:
        """
    ...
    ) -> list[EleCartesianMapInfo] | dict[str, Any]:
        """
    ...
    def ele_floor(
        self, ele_id, *, which="model", where="end", verbose=False, raises=True
    ) -> dict[str, Any]:
        """
    ...
    def ele_gen_gradients(
        ...
        """
        cmd = f"pipe ele:gen_gradients {ele_id}|{which} {index} {who}"
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="ele_gen_gradients", cmd_type="string_list"
        )

    def ele_grid_field(
        self, ele_id, index, who, *, which="model", verbose=False, raises=True
    ) -> list[EleGridFieldPointInfo] | dict[str, Any]:
        """
    ...
    def ele_head(self, ele_id, *, which="model", verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def ele_lord_slave(self, ele_id, *, verbose=False, raises=True) -> list[EleLordSlaveInfo]:
        """
    ...
    def ele_mat6(
        self, ele_id, *, which="model", who="mat6", verbose=False, raises=True
    ) -> dict[str, Any]:
        """
    ...
    def ele_param(
        self, ele_id, who, *, which="model", verbose=False, raises=True
    ) -> dict[str, Any]:
        """
    ...
    def ele_wake(
        self, ele_id, who, *, which="model", verbose=False, raises=True
    ) -> dict[str, Any] | list[list[float | str]] | np.ndarray:
        """
    ...
    def evaluate(
        self, expression, *, flags="-array_out", verbose=False, raises=True
    ...
    def em_field(
        self, ele_id, x, y, z, t_or_z, *, which="model", verbose=False, raises=True
    ) -> EmFieldResult:
        """
    ...
    def enum(self, enum_name, *, verbose=False, raises=True) -> list[EnumInfo]:
        """
    ...
    def floor_plan(self, graph, *, verbose=False, raises=True) -> list[FloorPlanElementInfo]:
        """
    ...
    def floor_orbit(self, graph, *, verbose=False, raises=True) -> list[FloorOrbitInfo]:
        """
    ...
    def tao_global(self, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def global_optimization(self, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def global_opti_de(self, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def help(self, *, verbose=False, raises=True) -> str:
        """
    ...
    def inum(self, who, *, verbose=False, raises=True) -> list[int]:
        """
    ...
    def lat_calc_done(self, branch_name, *, verbose=False, raises=True) -> bool:
        """
    ...
    def lat_ele_list(self, *, branch_name="", verbose=False, raises=True) -> list[str]:
        """
    ...
    def lat_header(self, *, ix_uni="", verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def lat_branch_list(
        self, *, ix_uni="", verbose=False, raises=True
    ) -> list[LatBranchListInfo]:
        """
    ...
    def lat_param_units(self, param_name, *, verbose=False, raises=True) -> str:
        """
    ...
    def lord_control(self, ele_id, *, verbose=False, raises=True) -> list[LordControlInfo]:
        """
    ...
    def matrix(self, ele1_id, ele2_id, *, verbose=False, raises=True) -> MatrixResult:
        """
    ...
    def merit(self, *, verbose=False, raises=True) -> float:
        """
    ...
    def place_buffer(self, *, verbose=False, raises=True) -> list[PlaceBufferInfo]:
        """
    ...
    def plot_curve(self, curve_name, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def plot_graph(self, graph_name, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def plot_histogram(self, curve_name, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def plot_lat_layout(
        self, ix_uni: 1, ix_branch: 0, *, verbose=False, raises=True
    ) -> list[PlotLatLayoutInfo]:
        """
    ...
    def plot_list(
        self, r_or_g, *, verbose=False, raises=True
    ) -> dict[str, int] | list[PlotListRegionInfo]:
        """
    ...
    def plot_symbol(
        self, region_name, graph_name, curve_name, x_or_y, *, verbose=False, raises=True
    ) -> list[PlotSymbolInfo] | np.ndarray:
        """
    ...
    def plot_transfer(self, from_plot, to_plot, *, verbose=False, raises=True) -> None:
        """
    ...
    def plot1(self, name, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def ptc_com(self, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def shape_list(self, who, *, verbose=False, raises=True) -> list[ShapeListInfo]:
        """
    ...
    def shape_manage(
        self, who, index, add_or_delete, *, verbose=False, raises=True
    ) -> dict[str, Any]:
        """
    ...
    def shape_pattern_list(
        self, *, ix_pattern="", verbose=False, raises=True
    ...
    def show(self, line, *, verbose=False, raises=True) -> list[str]:
        """
    ...
    def slave_control(self, ele_id, *, verbose=False, raises=True) -> list[SlaveControlInfo]:
        """
    ...
    def space_charge_com(self, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def species_to_int(self, species_str, *, verbose=False, raises=True) -> int:
        """
    ...
    def species_to_str(self, species_int, *, verbose=False, raises=True) -> str:
        """
    ...
    def spin_invariant(
        ...
        *,
        ...
        verbose=False,
        raises=True,
    ) -> np.ndarray | list[SpinInvariantInfo]:
        """
    ...
    def super_universe(self, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def taylor_map(
        self, ele1_id, ele2_id, *, order="1", verbose=False, raises=True
    ...
    def universe(self, ix_uni, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def var(
        self, var, *, slaves="", verbose=False, raises=True
    ) -> dict[str, Any] | list[VarSlaveInfo]:
        """
    ...
    def var_general(self, *, verbose=False, raises=True) -> list[VarGeneralInfo]:
        """
    ...
    def var_v_array(self, v1_var, *, verbose=False, raises=True) -> list[VarVArrayLineResult]:
        """
    ...
    def var_v1_array(
        self, v1_var, *, verbose=False, raises=True
    ) -> dict[str, VarV1ArrayDataInfo]:
        """
    ...
    def var_v1_create(
        self, v1_name, n_var_min, n_var_max, *, verbose=False, raises=True
    ) -> dict[str, Any]:
        """
    ...
    def var_v1_destroy(self, v1_datum, *, verbose=False, raises=True) -> dict[str, Any]:
        """
    ...
    def wave(
        self, who, *, verbose=False, raises=True
    ) -> dict[str, Any] | list[WaveKickInfo] | list[PlotLineInfo]:
        """
