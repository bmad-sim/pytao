...
# Generated on: 2026-02-11 16:58:54
# ==============================================================================
...
class _TaoAutogeneratedCommandMixin(TaoCore):
    ...
    def beam(self, ix_branch, *, ix_uni="", verbose=False, as_dict=True, raises=True):
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="beam", cmd_type="string_list")
    ...
    def data(
        ...
        *,
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="data", cmd_type="string_list")
    ...
    def enum(self, enum_name, *, verbose=False, as_dict=True, raises=True):
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="enum", cmd_type="string_list")
    ...
    def help(self, *, verbose=False, as_dict=True, raises=True):
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="help", cmd_type="string_list")
    ...
    def inum(self, who, *, verbose=False, as_dict=True, raises=True):
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="inum", cmd_type="string_list")
    ...
    def merit(self, *, verbose=False, as_dict=True, raises=True):
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="merit", cmd_type="string_list")
    ...
    def place_buffer(self, *, verbose=False, as_dict=True, raises=True):
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="place_buffer", cmd_type="None")
    ...
    def plot1(self, name, *, verbose=False, as_dict=True, raises=True):
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="plot1", cmd_type="string_list")
    ...
    def shape_set(
        ...
        *,
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="shape_set", cmd_type="None")
    ...
    def show(self, line, *, verbose=False, as_dict=True, raises=True):
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="show", cmd_type="string_list")
    ...
    def var(self, var, *, slaves="", verbose=False, as_dict=True, raises=True):
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="var", cmd_type="string_list")
    ...
    def wave(self, who, *, verbose=False, as_dict=True, raises=True):
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, as_dict, raises, method_name="wave", cmd_type="string_list")
