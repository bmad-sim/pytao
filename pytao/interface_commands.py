...
# Generated on: 2025-03-14 17:23:36
# ==============================================================================
    ...
    def init(
        ...
        *,
        ...
        if not self.init_settings.can_initialize and pathlib.Path(default_tao_init).exists():
            if (
                "-i" not in self.init_settings.command
                and "-l" not in self.init_settings.command
                and not self.init_settings.init_file
                and not self.init_settings.lattice_file
            ):
