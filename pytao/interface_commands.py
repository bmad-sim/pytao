...
# Generated on: 2025-03-10 16:17:10
# ==============================================================================
...
class Tao(TaoCore):
    ...
    def track_beam(
        ...
        *,
        ...
        parts = [set_beam_command]

        if not lat_calc_on:
            # Turn on lattice calculations for long enough to track the beam:
            parts.append("set global lattice_calc_on = T")
            parts.append("set global lattice_calc_on = F")
        if restore_track_type and set_beam_command != restore_beam_command:
            parts.append(restore_beam_command)
