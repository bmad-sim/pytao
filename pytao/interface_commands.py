...
# Generated on: 2026-03-13 14:10:14
# ==============================================================================
...
class _TaoAutogeneratedCommandMixin(TaoCore):
    _min_tao_version = datetime.datetime(2026, 3, 12)

    def beam(self, ix_branch, *, ix_uni="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="beam", cmd_type="string_list")

    def beam_init(self, ix_branch, *, ix_uni="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="beam_init", cmd_type="string_list")

    def bmad_com(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="bmad_com", cmd_type="string_list")

    def branch1(self, ix_uni, ix_branch, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="branch1", cmd_type="string_list")
    ...
    def bunch_comb(
        ...
        *,
        ...
        if verbose:
            print(cmd)
        if "-array_out" not in flags:
            return self._execute(cmd, raises, method_name="bunch_comb", cmd_type="string_list")
        if "-array_out" in flags:
            return self._execute(cmd, raises, method_name="bunch_comb", cmd_type="real_array")

    def bunch_params(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="bunch_params", cmd_type="string_list")

    def bunch1(
        self, ele_id, coordinate, *, which="model", ix_bunch="1", verbose=False, raises=True
    ):
        """
        ...
        if verbose:
            print(cmd)
        if coordinate in ["x", "px", "y", "py", "z", "pz", "s", "t", "charge", "p0c"]:
            return self._execute(cmd, raises, method_name="bunch1", cmd_type="real_array")
        if coordinate in ["state", "ix_ele"]:
            return self._execute(cmd, raises, method_name="bunch1", cmd_type="integer_array")

    def building_wall_list(self, *, ix_section="", verbose=False, raises=True):
        """
        ...
        return self._execute(
            cmd, raises, method_name="building_wall_list", cmd_type="string_list"
        )

    def building_wall_graph(self, graph, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="building_wall_graph", cmd_type="string_list"
        )
    ...
    def building_wall_point(
        ...
        *,
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="building_wall_point", cmd_type="None")

    def building_wall_section(
        self, ix_section, sec_name, sec_constraint, *, verbose=False, raises=True
    ):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="building_wall_section", cmd_type="None")

    def constraints(self, who, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="constraints", cmd_type="string_list")

    def da_aperture(self, *, ix_uni="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="da_aperture", cmd_type="string_list")

    def da_params(self, *, ix_uni="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="da_params", cmd_type="string_list")

    def data(self, d2_name, d1_name, *, ix_uni="", dat_index="1", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="data", cmd_type="string_list")

    def data_d_array(self, d2_name, d1_name, *, ix_uni="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="data_d_array", cmd_type="string_list")

    def data_d1_array(self, d2_datum, *, ix_uni="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="data_d1_array", cmd_type="string_list")

    def data_d2(self, d2_name, *, ix_uni="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="data_d2", cmd_type="string_list")

    def data_d2_array(self, ix_uni, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="data_d2_array", cmd_type="string_list")
    ...
    def data_d2_create(
        ...
        *,
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="data_d2_create", cmd_type="None")

    def data_d2_destroy(self, d2_name, *, ix_uni="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="data_d2_destroy", cmd_type="None")

    def data_parameter(self, data_array, parameter, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="data_parameter", cmd_type="string_list")

    def data_set_design_value(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="data_set_design_value", cmd_type="None")
    ...
    def datum_create(
        ...
        *,
        ...
        """
        cmd = f"pipe datum_create {datum_name}^^{data_type}^^{ele_start_name}^^{ele_ref_name}^^{ele_name}^^{merit_type}^^{meas}^^{good_meas}^^{ref}^^{good_ref}^^{weight}^^{good_user}^^{data_source}^^{eval_point}^^{s_offset}^^{ix_bunch}^^{invalid_value}^^{spin_axis_n0_1}^^{spin_axis_n0_2}^^{spin_axis_n0_3}^^{spin_axis_l_1}^^{spin_axis_l_2}^^{spin_axis_l_3}"
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="datum_create", cmd_type="string_list")

    def datum_has_ele(self, datum_type, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="datum_has_ele", cmd_type="string_list")

    def derivative(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="derivative", cmd_type="string_list")

    def ele_ac_kicker(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_ac_kicker", cmd_type="string_list")

    def ele_cartesian_map(
        self, ele_id, index, who, *, which="model", verbose=False, raises=True
    ):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="ele_cartesian_map", cmd_type="string_list"
        )
    ...
    def ele_chamber_wall(
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="ele_chamber_wall", cmd_type="string_list"
        )

    def ele_control_var(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="ele_control_var", cmd_type="string_list"
        )
    ...
    def ele_cylindrical_map(
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="ele_cylindrical_map", cmd_type="string_list"
        )

    def ele_elec_multipoles(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="ele_elec_multipoles", cmd_type="string_list"
        )

    def ele_floor(self, ele_id, *, which="model", where="end", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_floor", cmd_type="string_list")

    def ele_gen_attribs(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="ele_gen_attribs", cmd_type="string_list"
        )
    ...
    def ele_gen_grad_map(
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="ele_gen_grad_map", cmd_type="string_list"
        )

    def ele_grid_field(self, ele_id, index, who, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_grid_field", cmd_type="string_list")

    def ele_head(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_head", cmd_type="string_list")

    def ele_lord_slave(self, ele_id, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_lord_slave", cmd_type="string_list")

    def ele_mat6(self, ele_id, *, which="model", who="mat6", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_mat6", cmd_type="string_list")

    def ele_methods(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_methods", cmd_type="string_list")

    def ele_multipoles(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_multipoles", cmd_type="string_list")

    def ele_orbit(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_orbit", cmd_type="string_list")

    def ele_param(self, ele_id, who, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_param", cmd_type="string_list")

    def ele_photon(self, ele_id, who, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_photon", cmd_type="string_list")

    def ele_spin_taylor(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="ele_spin_taylor", cmd_type="string_list"
        )

    def ele_taylor(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_taylor", cmd_type="string_list")

    def ele_twiss(self, ele_id, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_twiss", cmd_type="string_list")

    def ele_wake(self, ele_id, who, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_wake", cmd_type="string_list")

    def ele_wall3d(self, ele_id, index, who, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ele_wall3d", cmd_type="string_list")

    def evaluate(self, expression, *, flags="-array_out", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        if "-array_out" not in flags:
            return self._execute(cmd, raises, method_name="evaluate", cmd_type="string_list")
        if "-array_out" in flags:
            return self._execute(cmd, raises, method_name="evaluate", cmd_type="real_array")

    def em_field(self, ele_id, x, y, z, t_or_z, *, which="model", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="em_field", cmd_type="string_list")

    def enum(self, enum_name, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="enum", cmd_type="string_list")

    def floor_plan(self, graph, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="floor_plan", cmd_type="string_list")

    def floor_orbit(self, graph, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="floor_orbit", cmd_type="string_list")

    def tao_global(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="tao_global", cmd_type="string_list")

    def global_optimization(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="global_optimization", cmd_type="string_list"
        )

    def global_opti_de(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="global_opti_de", cmd_type="string_list")

    def help(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="help", cmd_type="string_list")

    def inum(self, who, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="inum", cmd_type="string_list")

    def lat_calc_done(self, branch_name, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="lat_calc_done", cmd_type="string_list")

    def lat_ele_list(self, *, branch_name="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="lat_ele_list", cmd_type="string_list")

    def lat_header(self, *, ix_uni="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="lat_header", cmd_type="string_list")

    def lat_branch_list(self, *, ix_uni="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="lat_branch_list", cmd_type="string_list"
        )
    ...
    def lat_list(
        ...
        *,
        ...
        if verbose:
            print(cmd)
        if ("-array_out" not in flags) or (who in ["ele.name", "ele.key"]):
            return self._execute(cmd, raises, method_name="lat_list", cmd_type="string_list")
        if "-array_out" in flags and who in ["orbit.state", "ele.ix_ele"]:
            return self._execute(cmd, raises, method_name="lat_list", cmd_type="integer_array")
        if ("-array_out" in flags) or ("real:" in who):
            return self._execute(cmd, raises, method_name="lat_list", cmd_type="real_array")

    def lat_param_units(self, param_name, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="lat_param_units", cmd_type="string_list"
        )

    def lord_control(self, ele_id, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="lord_control", cmd_type="string_list")

    def matrix(self, ele1_id, ele2_id, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="matrix", cmd_type="string_list")

    def merit(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="merit", cmd_type="string_list")

    def orbit_at_s(
        self, *, ix_uni="", ele="", s_offset="", which="model", verbose=False, raises=True
    ):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="orbit_at_s", cmd_type="string_list")

    def place_buffer(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="place_buffer", cmd_type="None")

    def plot_curve(self, curve_name, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="plot_curve", cmd_type="string_list")

    def plot_graph(self, graph_name, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="plot_graph", cmd_type="string_list")

    def plot_histogram(self, curve_name, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="plot_histogram", cmd_type="string_list")

    def plot_lat_layout(self, ix_uni: 1, ix_branch: 0, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="plot_lat_layout", cmd_type="string_list"
        )

    def plot_list(self, r_or_g, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="plot_list", cmd_type="string_list")
    ...
    def plot_template_manage(
        ...
        *,
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="plot_template_manage", cmd_type="None")

    def plot_curve_manage(
        self, graph_name, curve_index, curve_name, *, verbose=False, raises=True
    ):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="plot_curve_manage", cmd_type="None")

    def plot_graph_manage(
        self, plot_name, graph_index, graph_name, *, verbose=False, raises=True
    ):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="plot_graph_manage", cmd_type="None")

    def plot_line(
        self, region_name, graph_name, curve_name, *, x_or_y="", verbose=False, raises=True
    ):
        """
        ...
        if verbose:
            print(cmd)
        if x_or_y == "":
            return self._execute(cmd, raises, method_name="plot_line", cmd_type="string_list")
        if x_or_y != "":
            return self._execute(cmd, raises, method_name="plot_line", cmd_type="real_array")
    ...
    def plot_symbol(
        ...
        if x_or_y == "":
            return self._execute(
                cmd, raises, method_name="plot_symbol", cmd_type="string_list"
            )
        if x_or_y != "":
            return self._execute(cmd, raises, method_name="plot_symbol", cmd_type="real_array")

    def plot_transfer(self, from_plot, to_plot, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="plot_transfer", cmd_type="None")

    def plot1(self, name, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="plot1", cmd_type="string_list")

    def ptc_com(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ptc_com", cmd_type="string_list")

    def ring_general(
        self, *, ix_uni="", ix_branch="", which="model", verbose=False, raises=True
    ):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="ring_general", cmd_type="string_list")

    def shape_list(self, who, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="shape_list", cmd_type="string_list")

    def shape_manage(self, who, index, add_or_delete, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="shape_manage", cmd_type="string_list")

    def shape_pattern_list(self, *, ix_pattern="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="shape_pattern_list", cmd_type="string_list"
        )

    def shape_pattern_manage(
        self, ix_pattern, pat_name, pat_line_width, *, verbose=False, raises=True
    ):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="shape_pattern_manage", cmd_type="None")

    def shape_pattern_point_manage(
        self, ix_pattern, ix_point, s, x, *, verbose=False, raises=True
    ):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="shape_pattern_point_manage", cmd_type="None"
        )
    ...
    def shape_set(
        ...
        *,
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="shape_set", cmd_type="None")

    def show(self, line, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="show", cmd_type="string_list")

    def slave_control(self, ele_id, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="slave_control", cmd_type="string_list")

    def space_charge_com(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="space_charge_com", cmd_type="string_list"
        )

    def species_to_int(self, species_str, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="species_to_int", cmd_type="string_list")

    def species_to_str(self, species_int, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="species_to_str", cmd_type="string_list")
    ...
    def spin_invariant(
        ...
        *,
        ...
        if "-array_out" not in flags:
            return self._execute(
                cmd, raises, method_name="spin_invariant", cmd_type="string_list"
            )
        if "-array_out" in flags:
            return self._execute(
                cmd, raises, method_name="spin_invariant", cmd_type="real_array"
            )
    ...
    def spin_polarization(
        ...
        if verbose:
            print(cmd)
        return self._execute(
            cmd, raises, method_name="spin_polarization", cmd_type="string_list"
        )
    ...
    def spin_resonance(
        ...
        *,
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="spin_resonance", cmd_type="string_list")

    def super_universe(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="super_universe", cmd_type="string_list")

    def taylor_map(self, ele1_id, ele2_id, *, order="1", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="taylor_map", cmd_type="string_list")
    ...
    def twiss_at_s(
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="twiss_at_s", cmd_type="string_list")

    def universe(self, ix_uni, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="universe", cmd_type="string_list")

    def var(self, var, *, slaves="", verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="var", cmd_type="string_list")
    ...
    def var_create(
        ...
        *,
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="var_create", cmd_type="string_list")

    def var_general(self, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="var_general", cmd_type="string_list")

    def var_v_array(self, v1_var, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="var_v_array", cmd_type="string_list")

    def var_v1_array(self, v1_var, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="var_v1_array", cmd_type="string_list")

    def var_v1_create(self, v1_name, n_var_min, n_var_max, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="var_v1_create", cmd_type="string_list")

    def var_v1_destroy(self, v1_datum, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="var_v1_destroy", cmd_type="string_list")

    def wall3d_radius(
        self, ix_uni, ix_branch, s_position, angle, *, verbose=False, raises=True
    ):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="wall3d_radius", cmd_type="string_list")

    def wave(self, who, *, verbose=False, raises=True):
        """
        ...
        if verbose:
            print(cmd)
        return self._execute(cmd, raises, method_name="wave", cmd_type="string_list")
    ...
    _autocomplete_usage_ = {
        ...
        "python": [("python", "")],
        "quit": [("quit", "")],
        "read": [("read lattice -silent -universes <universe-list> <file_name>", "")],
        "reinitialize": [
            ("reinitialize beam", ""),
            ("reinitialize data", ""),
        ...
        "write": [
            ...
            (
                "write pals <file_name>",
                "Write a PALS lattice file of the model in YAML format.",
            ),
